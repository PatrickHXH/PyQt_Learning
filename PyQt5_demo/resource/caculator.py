...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_20 = CaculatorBtn(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_4.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_3.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_2.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_8.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_6.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_5.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_7.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_11.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_9.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_10.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_12.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_15.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_13.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_14.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_16.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_19.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_18.key_pressed.connect(Form.get_key) # type: ignore
        self.pushButton_20.key_pressed.connect(Form.get_key) # type: ignore
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_8.setProperty("bg", _translate("Form", "orange"))
        self.pushButton_8.setProperty("role", _translate("Form", "operator"))
        ...
        self.pushButton_12.setProperty("bg", _translate("Form", "orange"))
        self.pushButton_12.setProperty("role", _translate("Form", "operator"))
        ...
        self.pushButton_16.setProperty("bg", _translate("Form", "orange"))
        self.pushButton_16.setProperty("role", _translate("Form", "operator"))
        ...
        self.pushButton_20.setProperty("bg", _translate("Form", "equal"))
        self.pushButton_20.setProperty("role", _translate("Form", "equal"))
