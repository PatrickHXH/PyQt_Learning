...
"}")
        ...
        self.auto_login_cb.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.remember_pwd_cb.setFont(font)
        self.remember_pwd_cb.setObjectName("remember_pwd_cb")
        self.gridLayout.addWidget(self.remember_pwd_cb, 2, 1, 1, 1)
...
"}")
        ...
        self.pushButton_2.clicked.connect(Form.open_qq_link) # type: ignore
        self.account_cb.editTextChanged['QString'].connect(Form.enable_login_btn) # type: ignore
        self.pwd_le.textChanged['QString'].connect(Form.enable_login_btn) # type: ignore
        self.login_btn.clicked.connect(Form.check_login) # type: ignore
        self.auto_login_cb.clicked['bool'].connect(Form.auto_login) # type: ignore
        self.remember_pwd_cb.clicked['bool'].connect(Form.remember_pwd) # type: ignore
    ...
    def retranslateUi(self, Form):
        ...
        self.account_cb.setItemText(0, _translate("Form", "123124"))
        self.account_cb.setItemText(1, _translate("Form", "111111"))
